			...
			<div class="row">
				<div class="col-sm-4">
					<form id="frmCategorias">
						...
						<p></p>
						<span class="btn btn-primary" id="btnAgregaCategoria">Añadir</span>
					</form>
				</div>
				<div class="col-sm-6">
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$('#btnAgregaCategoria').click(function() {
				...
				if (vacios > 0) {
					alertify.alert("Existen campos vacíos");
					return false;
				}
				...
				$.ajax({
					...
					success: function(r) {
						if (r == 1) {
							...
							$('#tablaCategoriaLoad').load("categorias/tablaCategorias.php");
							alertify.success("Categoria añadida con éxito");
						} else {
							alertify.error("No se pudo añadir categoria");
						}
					}
				});
			});
			...
			alertify.confirm('¿Desea eliminar esta categoria?', function() {
				$.ajax({
					...
					success: function(r) {
						if (r == 1) {
							$('#tablaCategoriaLoad').load("categorias/tablaCategorias.php");
							alertify.success("Eliminada con éxito");
						} else {
